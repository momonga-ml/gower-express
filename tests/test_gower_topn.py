...
class TestGowerTopN:
    ...
    def test_basic_gower_topn(self):
        ...
        result = gower.gower_topn(X, Y, n=3)
    ...
    def test_gower_topn_n_greater_than_dataset(self):
        ...
        result = gower.gower_topn(X, Y, n=10)
    ...
    def test_gower_topn_with_weights(self):
        ...
        result = gower.gower_topn(X, Y, weight=weights, n=2)
    ...
    def test_gower_topn_with_cat_features(self):
        ...
        result = gower.gower_topn(X, Y, cat_features=cat_features, n=2)
        assert len(result['index']) == 2
    ...
    def test_gower_topn_pandas_dataframe(self):
        ...
        result = gower.gower_topn(X_df, Y_df, n=2)
        assert len(result['index']) == 2
    ...
    def test_gower_topn_optimized_path(self):
        ...
        result = gower.gower_topn(X, Y, n=10, use_optimized=True)
    ...
    def test_gower_topn_non_optimized_path(self):
        ...
        result = gower.gower_topn(X, Y, n=5, use_optimized=False)
    ...
    def test_gower_topn_with_missing_values(self):
        ...
        result = gower.gower_topn(X, Y, n=2)
        assert len(result['index']) == 2
    ...
    def test_gower_topn_single_result(self):
        ...
        result = gower.gower_topn(X, Y, n=1)
    ...
    def test_gower_topn_optimized_heap_algorithm(self):
        ...
        result = gower.gower_topn(X, Y, n=20, use_optimized=True)
