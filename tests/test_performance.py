...
class TestPerformanceOptimizations:
    ...
    def test_compute_ranges_numba(self):
        ...
        with patch('gower.gower_dist.compute_ranges_numba') as mock_compute:
    ...
    def test_smallest_indices_numba(self):
        ...
        with patch('gower.gower_dist.smallest_indices_numba') as mock_smallest:
    ...
    def test_gpu_matrix_computation(self, mock_cp):
        ...
        with patch('gower.gower_dist.get_array_module', return_value=mock_cp):
    ...
    def test_parallel_processing_large_dataset(self):
        ...
        result_parallel = gower.gower_matrix(X, n_jobs=2)
        result_sequential = gower.gower_matrix(X, n_jobs=1)
    ...
    def test_parallel_chunk_computation(self):
        ...
        chunk_result = gd._compute_chunk(
            0, 2, X_cat, X_num, Y_cat, Y_num,
            weight_cat, weight_num, weight_sum, cat_features,
            num_ranges, num_max, 4, 4
        )
    ...
    def test_heap_based_topn_optimization(self):
        ...
        result = gd._gower_topn_heap(
            ...
            weight_cat, weight_num, weight_sum,
            num_ranges, n=10, total_rows=100
        )
    ...
    def test_optimized_topn_large_dataset(self):
        ...
        result = gower.gower_topn(X, Y, n=30, use_optimized=True)
    ...
    def test_optimized_topn_early_stopping(self):
        ...
        result = gower.gower_topn(X, Y, n=3, use_optimized=True)
        assert len(result['index']) == 3
        # First 3 should be the closest
        assert all(idx < 3 for idx in result['index'])
    
    @patch('gower.gower_dist.Parallel')
