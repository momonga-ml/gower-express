...
class TestAdditionalCoverage:
    ...
    def test_vectorized_gpu_all_features(self):
        ...
        result = gd.gower_matrix_vectorized_gpu(
            ...
            num_ranges, is_symmetric=True, xp=np
        )
    ...
    @patch('gower.gower_dist.NUMBA_AVAILABLE', True) 
    @patch('gower.gower_dist.compute_ranges_numba', side_effect=Exception("Error"))
    ...
    @patch('gower.gower_dist.NUMBA_AVAILABLE', True)
    @patch('gower.gower_dist.smallest_indices_numba', side_effect=Exception("Error"))
    ...
    def test_gower_topn_optimized_large_n(self):
        ...
        result = gower.gower_topn(X, Y, n=60, use_optimized=True)  # n > 50
    ...
    def test_parallel_negative_n_jobs(self):
        ...
        with patch('gower.gower_dist.os.cpu_count', return_value=8):
            result = gower.gower_matrix(X, n_jobs=-3)  # Should use 6 cores
    ...
    def test_gpu_exception_handling(self):
        ...
        with patch('gower.gower_dist.GPU_AVAILABLE', True):
            with patch('gower.gower_dist.cp') as mock_cp:
    ...
    def test_chunk_symmetric_case(self):
        ...
        result = gd._compute_chunk(
            0, 1, X_cat, X_num, X_cat, X_num,
            weight_cat, weight_num, weight_sum, cat_features,
            num_ranges, num_max, 2, 2
        )
    ...
    def test_compute_single_distance_zero_ranges(self):
        ...
        result = gd._compute_single_distance(
            query_cat, query_num, row_cat, row_num,
